...
def survey():
    ...
    data = {
        "user": [u for u in form_data.get("user", [])],
        "details": [
            {
                "name": form_data.get("project", {}).get("project_name", ""),
                "short_name": form_data.get("project", {}).get("project_short_name", ""),
                "programme_name": form_data.get("project", {}).get("programme_name", ""),
                "programme_short_name": form_data.get("project", {}).get("programme_short_name", ""),
                "documentation_link": [form_data.get("project", {}).get("doc_link", "")],
                "project_description": form_data.get("project", {}).get("project_description", ""),
            }
        ],
        "developed": [form_data.get("developed", {}).get("developed", ""), [developed_company]],
        "source_control": form_data.get("source_control", []),
        "architecture": {
