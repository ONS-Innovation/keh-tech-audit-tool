...
whenever the deployment pipeline needs to be used. Follow the instructions on the Confluence page to
login (SDP Homepage > SDP Login > Concourse Login). All our pipelines run on sdp-pipeline-prod, whereas sdp-pipeline-dev is the account used for
